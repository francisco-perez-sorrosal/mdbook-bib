...
- **citation:** Clean up REF_PATTERN (9698956)

- **ci:** Grant write permission to pull-requests in code review workflow (7942370)


### Features

- **examples:** Add copy-to-clipboard button to basic example (e1ad0c6)


### Other

- Auto-update changelog!!! (69246eb)

- Auto-update changelog!!! (ba0fba4)

- Reduce logging verbosity (43f27eb)

- Auto-update changelog!!! (5574dac)


### Refactoring

- Reorganize test books into example_books directory (48d68f6)

- Move templates to example_books directory (7f76211)
...
- Prepare for release v0.5.2 (6b7ea1c)
