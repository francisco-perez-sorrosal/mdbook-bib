...
**mdbook-bib** is a {{#cite mdBook}} plugin for creating a bibliography and reference its citations in your books. mdBook is written in the Rust language @@Klabnik2018.
